...
public class TTTGraphics extends JFrame {
    ...
    public static final int CELL_SIZE = 180; // cell width/height (square)
    ...
    public static final Color COLOR_BG_STATUS = new Color(165, 79, 79);
    public static final Color COLOR_GRID   = Color.LIGHT_GRAY;  // grid lines
    public static final Color COLOR_CROSS  = new Color(45, 73, 211);  // Red #D32D41
    public static final Color COLOR_NOUGHT = new Color(245, 76, 191); // Blue #4CB5F5
